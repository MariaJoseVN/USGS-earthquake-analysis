# aquí van las pruebas de código
...
resumen_anual <- sismos |>
  group_by(año) |>
  summarise(
    n = n(),
    mag_promedio = mean(mag, na.rm = TRUE),
    .groups = "drop"
  )

print(resumen_anual, n = Inf)
