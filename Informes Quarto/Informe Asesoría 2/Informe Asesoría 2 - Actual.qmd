...
También se consideró PERMANOVA como alternativa no paramétrica multivariante. Sin embargo, no se adoptó como procedimiento principal porque su resultado depende de una matriz de distancias y puede confundirse con diferencias de dispersión entre grupos, precisamente una de las heterogeneidades observadas en el catálogo. Además, la pregunta de esta sección requiere interpretar separadamente magnitud y profundidad, por lo que se priorizó Kruskal-Wallis por variable, complementado con comparaciones post-hoc y tamaños de efecto.
...
Para complementar esas comparaciones, se calculó delta de Cliff en pares sustantivamente relevantes [@cliff_1993]. Esta medida cumple una función similar a un tamaño de efecto por pares, como Cohen's d en análisis paramétricos, pero no compara medias ni depende de desviaciones estándar. En su lugar, estima qué tan dominante es una distribución sobre otra, por lo que permite describir dirección y magnitud práctica de la separación entre zonas aun cuando las distribuciones no son normales.
