...
- Guía Metodológica de Delimitación de Zonas en QGIS: \asesoriaExternalLink{https://mariajosevn.github.io/USGS-earthquake-analysis/MAPA\_HTML/Gu\%C3\%ADa\%20metodol\%C3\%B3gica\%20para\%20la\%20delimitaci\%C3\%B3n\%20de\%20zonas\%20s\%C3\%ADsmicas\%20globales\%20en\%20QGIS.pdf}{Abrir guía metodológica}
...
\end{tabular}
\par\vspace{0.10em}
\localtablecaption[0.78\linewidth]{tbl-diagnosticos-complementarios-mag-depth}{Diagnósticos complementarios para magnitud y profundidad.}
\endgroup
\end{minipage}
\par\vspace{0.15em}
```
...
\begin{tabular}{@{}l@{\hspace{0.8em}}c@{\hspace{0.7em}}c@{\hspace{0.7em}}c@{\hspace{0.7em}}c@{\hspace{0.8em}}l@{}}
\toprule
...
\end{tabular}
\par\vspace{0.10em}
\localtablecaption[0.82\linewidth]{tbl-kruskal-mag-depth}{Comparación global de magnitud y profundidad entre zonas mediante Kruskal-Wallis y tamaño de efecto.}
\endgroup
\end{minipage}
\par\vspace{-0.25em}
```
...
\begin{tabular}{@{}l@{\hspace{0.8em}}l@{\hspace{0.7em}}c@{\hspace{0.7em}}c@{\hspace{0.8em}}l@{}}
\toprule
...
\end{tabular}
\par\vspace{0.10em}
\localtablecaption[0.84\linewidth]{tbl-cliff-mag-depth}{Tamaños de efecto por pares mediante delta de Cliff.}
\endgroup
\end{minipage}
\par\vspace{-0.25em}
```
...
\end{tabular}
\par\vspace{0.10em}
\localtablecaption[0.84\linewidth]{tbl-temporal-adf-kpss}{Resultados de estacionariedad e independencia serial para las series anual y mensual de conteos.}
\endgroup
\end{minipage}
\par\vspace{-0.25em}
```
...
\end{tabular}
\par\vspace{0.15em}
\localtablecaption[0.78\linewidth]{tbl-temporal-tasas-periodo}{Conteos anuales por período del catálogo.}
\endgroup
\end{minipage}\hfill
...
\end{tabular}
\par\vspace{0.15em}
\localtablecaption[0.82\linewidth]{tbl-temporal-modelo-periodo}{Contraste del efecto período en los conteos anuales.}
\endgroup
\end{minipage}
\par\vspace{0.45em}
```
...
\end{tabular}
\par\vspace{0.10em}
\localtablecaption[0.78\linewidth]{tbl-temporal-estacionalidad-mensual}{Contraste de estacionalidad mensual en los conteos del catálogo.}
\endgroup
\end{minipage}
\par\vspace{-0.25em}
```
...
\begin{figure}[H]
\centering
\includegraphics[width=0.60\textwidth]{\detokenize{../Imágenes y Recursos/inf2-clasificacion-roc.png}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.62\textwidth]{\detokenize{../Imágenes y Recursos/inf2-clasificacion-espacio.png}}
...
La delimitación de las zonas se conserva desde el Informe Asesoría 1. El procedimiento completo de delimitación, elaborado por el equipo, se documenta en la \asesoriaExternalLink{https://mariajosevn.github.io/USGS-earthquake-analysis/MAPA\_HTML/Gu\%C3\%ADa\%20metodol\%C3\%B3gica\%20para\%20la\%20delimitaci\%C3\%B3n\%20de\%20zonas\%20s\%C3\%ADsmicas\%20globales\%20en\%20QGIS.pdf}{guía metodológica de delimitación de zonas sísmicas globales en QGIS}. En esta etapa, QGIS también se utiliza para calcular la superficie de los polígonos y construir la capa `MAPA_HTML/zonas_inf2.geojson`. R importa estas superficies para expresar la frecuencia como densidad de eventos y utilizarlas como exposición en los modelos de conteo.
