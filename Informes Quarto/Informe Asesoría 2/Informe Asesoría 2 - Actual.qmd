...
\end{tabular}
\par\vspace{0.10em}
{\footnotesize\itshape Tabla~\ref*{tbl-diagnosticos-complementarios-mag-depth}. Diagnósticos complementarios para magnitud y profundidad.\par}
\endgroup
\end{minipage}
\par\vspace{0.15em}
```
...
\end{tabular}
\par\vspace{0.10em}
{\footnotesize\itshape Tabla~\ref*{tbl-kruskal-mag-depth}. Comparación global de magnitud y profundidad entre zonas mediante Kruskal-Wallis y tamaño de efecto.\par}
\endgroup
\end{minipage}
\par\vspace{-0.25em}
```
...
\end{tabular}
\par\vspace{0.10em}
{\footnotesize\itshape Tabla~\ref*{tbl-cliff-mag-depth}. Tamaños de efecto por pares mediante delta de Cliff.\par}
\endgroup
\end{minipage}
\par\vspace{-0.25em}
```
...
\end{tabular}
\par\vspace{0.10em}
{\footnotesize\itshape Tabla~\ref*{tbl-temporal-adf-kpss}. Resultados de estacionariedad e independencia serial para las series anual y mensual de conteos.\par}
\endgroup
\end{minipage}
\par\vspace{-0.25em}
```
...
\end{tabular}
\par\vspace{0.10em}
{\footnotesize\itshape Tabla~\ref*{tbl-temporal-estacionalidad-mensual}. Contraste de estacionalidad mensual en los conteos del catálogo.\par}
\endgroup
\end{minipage}
\par\vspace{-0.25em}
```
...
\end{tabular}
\par\vspace{0.10em}
{\footnotesize\itshape Tabla~\ref*{tbl-temporal-exponencial}. Ajuste exponencial de los tiempos entre eventos consecutivos.\par}
\endgroup
\end{minipage}
\par\vspace{-0.25em}
```
