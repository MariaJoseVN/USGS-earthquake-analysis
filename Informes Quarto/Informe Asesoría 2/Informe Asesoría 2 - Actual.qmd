...
Cuando el contraste global indicó diferencias, aplicamos comparaciones post-hoc de Dunn con ajuste de Holm [@dunn_1964; @holm_1979]. El ajuste controla el error tipo I acumulado al realizar seis comparaciones por pares dentro de cada variable. La tabla completa se presenta en el \asesoriaStyledRef{(véase \hyperref[sec-anexo-dunn]{anexo de comparaciones Dunn-Holm})}. Además, se calculó delta de Cliff en pares sustantivamente relevantes para describir dirección y magnitud práctica de la separación entre distribuciones [@cliff_1993].
