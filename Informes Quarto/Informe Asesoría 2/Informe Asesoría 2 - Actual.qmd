...
La capacidad clasificatoria se evaluó primero con la matriz de confusión bajo la regla de máxima probabilidad, que asigna cada evento a la zona con mayor probabilidad ajustada. A partir de ella se calcularon tres métricas. La exactitud global se comparó con la base trivial de clasificar siempre la zona mayoritaria (75,2 % de los eventos); la exactitud balanceada se obtuvo como promedio de las sensibilidades por zona, decisiva ante el desbalance porque pondera igual a las cuatro zonas; y la sensibilidad de cada zona se definió como la proporción de eventos de esa zona correctamente identificados.
