...
\vspace{0pt}
La \asesoriaTableRef{tbl-clasificacion-metricas} resume la capacidad clasificatoria del modelo corregido bajo la regla de máxima probabilidad \asesoriaParenRef{véase \hyperref[sec-anexo-metricas-clasificacion]{anexo de métricas de clasificación}}. El modelo asignó los 1.186 eventos al Cinturón de Fuego. Reconoció sus 892 eventos y ningún evento de las tres zonas restantes.
\end{minipage}\hfill
