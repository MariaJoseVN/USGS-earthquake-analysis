...
La clasificación por `magnitud_cat` confirma esta lectura: 67,37% de los eventos corresponde a la categoría Fuerte, 27,66% a Mayor y 4,97% a Grande o extremo. \emph{(véase \hyperref[tbl-categoria-magnitud]{tabla~\ref*{tbl-categoria-magnitud}})}.
