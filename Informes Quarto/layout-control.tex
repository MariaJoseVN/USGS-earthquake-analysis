...
\definecolor{asesoriaTextColor}{HTML}{001632}
...
\AtBeginDocument{%
  ...
  \addtokomafont{disposition}{\color{asesoriaTextColor}}%
  \addtokomafont{pageheadfoot}{\color{asesoriaTextColor}}%
  \addtokomafont{pagenumber}{\color{asesoriaTextColor}}%
